...
location_table: Dict[str, REPOLocationData] = { 
    ...
    # -- Museum of Human Art --
    lname.egg:           REPOLocationData(rname.museum,(v:=v+1),"Heavy Valuable"),
    ...
    lname.cool_brain:    REPOLocationData(rname.museum,(v:=v+1),"Medium Valuable"),
    ...
    lname.horse:         REPOLocationData(rname.museum,(v:=v+1),"Heavy Valuable"),
    lname.blender:       REPOLocationData(rname.museum,(v:=v+1),"Heavy Valuable"),
    lname.mug_deluxe:    REPOLocationData(rname.museum,(v:=v+1),"Heavy Valuable"),
    lname.gumball:       REPOLocationData(rname.museum,(v:=v+1),"Medium Valuable"),
    lname.traffic_light: REPOLocationData(rname.museum,(v:=v+1),"VeryHeavy Valuable"),
    lname.milk:          REPOLocationData(rname.museum,(v:=v+1),"VeryHeavy Valuable"),
