...
every_bug = [  # Regions values are noncomprehensive. Regions are excluded if there's a current overlap in access requirements.
    BugType(name=i.glowbug,        bug_id=1,  slot_cost=2, regions=[r.lost_swamp]),
    BugType(name=i.frog,           bug_id=2,  slot_cost=1, regions=[r.lost_swamp]),
    BugType(name=i.fly,            bug_id=3,  slot_cost=2, regions=[r.lost_swamp]),
    BugType(name=i.dragonfly,      bug_id=4,  slot_cost=2, regions=[r.lost_swamp]),
    BugType(name=i.eel,            bug_id=5,  slot_cost=2, regions=[r.lost_swamp]),  # Requires Dash or Frog. Eel requires Groth defeat
    BugType(name=i.bass,           bug_id=6,  slot_cost=1, regions=[r.lost_swamp]),  # Blue's Cabin
    BugType(name=i.blue_snack,     bug_id=7,  slot_cost=3, regions=[r.marvins, r.workshop]),
    BugType(name=i.purple_snack,   bug_id=8,  slot_cost=4, regions=[r.marvins]),	
    BugType(name=i.magnet_roach,   bug_id=9,  slot_cost=1, regions=[r.yellow_forest, r.ridge]),  # For sale, or eatable during Runi fight
    BugType(name=i.mushroll,       bug_id=10, slot_cost=2, regions=[r.marvins]),
    BugType(name=i.mushfrog,       bug_id=11, slot_cost=1, regions=[r.marvins, r.treetops]),
...
combat_data = [
    ...
    CombatType(name=c.treetops_arena_2,        score_easy=X, score_normal=0, score_hard=0, score_very_hard=0,),
    ...
    CombatType(name=c.old_wood_arena_1,        score_easy=X, score_normal=X, score_hard=X, score_very_hard=0,),
    CombatType(name=c.old_wood_arena_2,        score_easy=X, score_normal=X, score_hard=X, score_very_hard=0,),
    CombatType(name=c.estate_general,          score_easy=X, score_normal=X, score_hard=X, score_very_hard=0,),
    CombatType(name=c.fog_garden_general,      score_easy=X, score_normal=X, score_hard=X, score_very_hard=0,),
    CombatType(name=c.fog_garden_arena_1,      score_easy=X, score_normal=X, score_hard=X, score_very_hard=0,),
    CombatType(name=c.fog_garden_arena_2,      score_easy=X, score_normal=X, score_hard=X, score_very_hard=0,),
    CombatType(name=c.hive_general,            score_easy=X, score_normal=X, score_hard=X, score_very_hard=0,),
    CombatType(name=c.well_general,            score_easy=X, score_normal=X, score_hard=X, score_very_hard=0,),
    CombatType(name=c.thickness_general,       score_easy=X, score_normal=X, score_hard=X, score_very_hard=0,),
    CombatType(name=c.thickness_arena_1,       score_easy=X, score_normal=X, score_hard=X, score_very_hard=0,),
    CombatType(name=c.ridge_general,           score_easy=X, score_normal=X, score_hard=X, score_very_hard=0,),
    CombatType(name=c.moridonos_general,       score_easy=X, score_normal=X, score_hard=X, score_very_hard=0,),
    CombatType(name=c.moridonos_arena_1,       score_easy=X, score_normal=X, score_hard=X, score_very_hard=0,),
    CombatType(name=c.moridonos_arena_2,       score_easy=X, score_normal=X, score_hard=X, score_very_hard=0,),
    CombatType(name=c.moridonos_arena_3,       score_easy=X, score_normal=X, score_hard=X, score_very_hard=0,),
    CombatType(name=c.moridonos_arena_4,       score_easy=X, score_normal=X, score_hard=X, score_very_hard=0,),
    CombatType(name=c.under_under_general,     score_easy=X, score_normal=X, score_hard=X, score_very_hard=0,),
    CombatType(name=c.under_under_arena_1,     score_easy=X, score_normal=X, score_hard=X, score_very_hard=0,),
    CombatType(name=c.deep_general,            score_easy=X, score_normal=X, score_hard=X, score_very_hard=0,),
    CombatType(name=c.deep_arena_1,            score_easy=X, score_normal=X, score_hard=X, score_very_hard=0,),
    CombatType(name=c.reef_arena_1,            score_easy=X, score_normal=X, score_hard=X, score_very_hard=0,),
    CombatType(name=c.reef_general,            score_easy=X, score_normal=X, score_hard=X, score_very_hard=0,),
    CombatType(name=c.rootden_general,         score_easy=X, score_normal=X, score_hard=X, score_very_hard=0,),
