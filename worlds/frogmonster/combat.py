...
combat_data = [
    ...
    CombatType(name=c.ridge_general,           score_easy=X, score_normal=X, score_hard=3, score_very_hard=0,),
    CombatType(name=c.moridonos_general,       score_easy=X, score_normal=X, score_hard=3, score_very_hard=0,),
    CombatType(name=c.moridonos_arena_1,       score_easy=X, score_normal=X, score_hard=5, score_very_hard=0,),
    CombatType(name=c.moridonos_arena_2,       score_easy=X, score_normal=X, score_hard=5, score_very_hard=0,),
    CombatType(name=c.moridonos_arena_3,       score_easy=X, score_normal=X, score_hard=5, score_very_hard=0,),
    CombatType(name=c.moridonos_arena_4,       score_easy=X, score_normal=X, score_hard=5, score_very_hard=0,),
    CombatType(name=c.under_under_general,     score_easy=X, score_normal=X, score_hard=3, score_very_hard=0,),
    CombatType(name=c.under_under_arena_1,     score_easy=X, score_normal=X, score_hard=5, score_very_hard=0,),
    ...
    CombatType(name=c.reef_arena_1,            score_easy=X, score_normal=X, score_hard=2, score_very_hard=0,),
    CombatType(name=c.reef_general,            score_easy=X, score_normal=X, score_hard=5, score_very_hard=0,),
    CombatType(name=c.rootden_general,         score_easy=X, score_normal=X, score_hard=3, score_very_hard=0, need=[i.tongue_swing]),
    CombatType(name=c.quarry_general,          score_easy=X, score_normal=X, score_hard=3, score_very_hard=0,),
    CombatType(name=c.quarry_arena_1,          score_easy=X, score_normal=X, score_hard=5, score_very_hard=0,),
    CombatType(name=c.temple_general,          score_easy=X, score_normal=X, score_hard=4, score_very_hard=0,),
